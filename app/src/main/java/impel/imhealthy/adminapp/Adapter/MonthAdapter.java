...
public class MonthAdapter extends RecyclerView.Adapter<MonthAdapter.ViewHolder> {
    ...
    protected List<MonthSortingModel> data = new ArrayList<>();


    public MonthAdapter(Context context, List<MonthSortingModel> data) {
    ...
    public MonthAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        MonthAdapter.ViewHolder vh = new MonthAdapter.ViewHolder(v);
        return vh;
    }
    ...
    public void onBindViewHolder(@NonNull MonthAdapter.ViewHolder viewHolder, int i) {
        ...
        final MonthSortingModel d = data.get(i);
