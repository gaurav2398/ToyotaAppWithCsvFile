...
public class WeekAdapter extends RecyclerView.Adapter<WeekAdapter.ViewHolder> {
    ...
    protected List<WeekSortingModel> data = new ArrayList<>();


    public WeekAdapter(Context context, List<WeekSortingModel> data) {
    ...
    public WeekAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        WeekAdapter.ViewHolder vh = new WeekAdapter.ViewHolder(v);
        return vh;
    }
    ...
    public void onBindViewHolder(@NonNull WeekAdapter.ViewHolder viewHolder, int i) {
        ...
        final WeekSortingModel d = data.get(i);
