...
import impel.imhealthy.adminapp.Adapter.MonthAdapter;
...
public class MonthFragment extends Fragment {
    ...
    public MonthAdapter dayAdapter;

    String getpostid, hash_id, role;
    SessionManager session;
    StringRequest stringRequest;
    RequestQueue mRequestQueue;
    ArrayList<MonthSortingModel> dm = new ArrayList<MonthSortingModel>();
    String userid;
    DatabaseHelper mydb;
...
//        mydb.delete();
        ...
        dayAdapter = new MonthAdapter(getActivity(), dm);      //ds=model       d=Model
...
//        getusertempNew();
        ...
        String lastWeekDate  = getCalculatedDate(currentDate, "dd-MM-yyyy", -30);  // It will gives you date after 10 days from given date

        dm.addAll(mydb.getAllDataHistoryMonthly(currentDate,lastWeekDate));
        dayAdapter = new MonthAdapter(getActivity(), dm);      //ds=model       d=Model
        mRecyclerView.setAdapter(dayAdapter);
                ...
                llinstagram.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (isAppInstalled) {
                            ...
                            shareIntent.putExtra(Intent.EXTRA_STREAM, Uri.parse(Environment.getExternalStorageDirectory() + File.separator + "MonthlyReport.csv"));
                ...
                llwhatsapp.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (isAppInstalled) {
                            ...
                            shareIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                            shareIntent.putExtra(Intent.EXTRA_TEXT, "Via I'm Healthy Application");
                            shareIntent.putExtra(Intent.EXTRA_STREAM, Uri.parse(Environment.getExternalStorageDirectory() + File.separator + "/Im Healthy Admin/MonthlyReport.csv"));
                ...
                llmessage.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        try {
                            ...
                            File f = new File(Environment.getExternalStorageDirectory(), "Im Healthy Admin/MonthlyReport.csv");
                            final String[] TO = {""};
    ...
    private void exportDB() {
        ...
        File file = new File(exportDir, "MonthlyReport.csv");
        try {
            file.createNewFile();
                        ...
                        try {
                            ...
                            if (status.equals("200")) {
                                ...
                                for (int i = 0; i < applist1.length(); i++) {
                                    ...
                                    MonthSortingModel model = new MonthSortingModel();
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String ServerResponse) {
                        ...
                        try {
                            ...
                            Log.d("admin_get_temp", ServerResponse);
                            String status = j.getString("status");
                            String msg = j.getString("msg");
                            ...
                            if (status.equals("200")) {
                                ...
                                for (int i = 0; i < applist1.length(); i++) {
                                    ...
                                    //to get only monthly data
                                    //if (jsonObject.getString("member_id").equals(userid)) {
