...
import impel.imhealthy.adminapp.Adapter.TabsAdapterNew;
...
public class HistoySortingActivity extends AppCompatActivity implements ActionBar.TabListener{


    private ViewPager mViewPager;
    TabsAdapterNew tabsAdapter;
    ImageView back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_histoy_sorting);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent a = new Intent(HistoySortingActivity.this,HomeScreen.class);
                startActivity(a);
                finish();
            }
        });
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(HistoySortingActivity.this, HomeScreen.class));
            }
        });
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent =  new Intent(HistoySortingActivity.this, ProfileActivity.class);
        ...
        setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent =  new Intent(HistoySortingActivity.this, SettingActivity.class);
                startActivity(intent);
            }
        });
        tabsAdapter = new TabsAdapterNew(getSupportFragmentManager());
